...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-80 border-r border-slate-200/80 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/60 flex flex-col h-screen shrink-0 transition-colors">
        ...
        >
          ...
          {isUploading ? (
            <div className="flex flex-col items-center gap-2 py-2">
              ...
              <div className="text-xs font-semibold text-slate-700 dark:text-slate-200">Processing & Indexing...</div>
              <div className="text-[11px] text-slate-400">Embedding multilingual vectors</div>
            </div>
          ) : (
            <div className="flex flex-col items-center gap-1.5 py-1">
              <div className="w-9 h-9 rounded-full bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 flex items-center justify-center">
      ...
      <div className="px-4 pb-2 flex items-center justify-between text-xs font-semibold uppercase tracking-wider text-slate-400 dark:text-slate-500">
      ...
      <div className="px-3 pb-2">
        <button
          ...
          className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs font-medium transition-all ${
            selectedDocId === null
              ? 'bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 font-semibold shadow-xs'
                ...
                <div className="flex items-start gap-2.5 min-w-0 pr-1">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 text-[11px] text-slate-400 dark:text-slate-500 mt-0.5">
                      ...
                      <span>•</span>
                      <span className="uppercase text-[10px] bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 px-1 py-0.2 rounded">
